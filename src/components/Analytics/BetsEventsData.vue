        ...
        <Table>
            <TableHeader>
                <TableRow>
                    ...
                    <TableHead>Hits Percentage</TableHead>
                    <TableHead>Partial Hits Percentage</TableHead>
                    <TableHead>Price</TableHead>
                    <TableHead>Total Bets</TableHead>
                    <TableHead>Total Errors</TableHead>
                    <TableHead>Total Hits</TableHead>
                    <TableHead>Total Partial Hits</TableHead>
                    <TableHead>Users quantity</TableHead>
                </TableRow>
            </TableHeader>
            <TableBody>
